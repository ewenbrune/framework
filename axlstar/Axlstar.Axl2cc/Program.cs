...
namespace Axlstar.Axl
{
  public class MainAXL2CC
  {
    ...
    bool _HasLegacyOption(string[] args)
    {
    ...
    public int Execute(string[] args)
    {
      ...
      var x = new Axlstar.Axl.Generator();
      return x.Execute(args);
    }
    int _Execute2(string[] args)
    {
      int nb_arg = args.Length;
    ...
    {
      Console.WriteLine("Usage: axl.exe [--legacy] [-i|--header header] [-o|--output output_path]" +
